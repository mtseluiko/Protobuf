...
var symbolicNames = [ null, "SYNTAX", "IMPORT", "WEAK", "PUBLIC", "PACKAGE", 
                      ...
                      "PROTO3_LIT_SINGLE", "PROTO3_LIT_DOBULE", "PROTO2_LIT_SINGLE", 
                      "PROTO2_LIT_DOBULE", "SEMI", "EQ", "LP", "RP", "LB", 
                      "RB", "LC", "RC", "LT", "GT", "DOT", "COMMA", "COLON", 
...
Protobuf3Parser.PROTO2_LIT_SINGLE = 36;
Protobuf3Parser.PROTO2_LIT_DOBULE = 37;
...
Protobuf3Parser.prototype.syntax = function() {
    ...
    try {
        ...
        _la = this._input.LA(1);
        if(!(((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (Protobuf3Parser.PROTO3_LIT_SINGLE - 34)) | (1 << (Protobuf3Parser.PROTO3_LIT_DOBULE - 34)) | (1 << (Protobuf3Parser.PROTO2_LIT_SINGLE - 34)) | (1 << (Protobuf3Parser.PROTO2_LIT_DOBULE - 34)))) !== 0))) {
...
Protobuf3Parser.prototype.strLit = function() {
    ...
    try {
        ...
        this.state = 465;
        _la = this._input.LA(1);
        if(!(((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (Protobuf3Parser.PROTO3_LIT_SINGLE - 34)) | (1 << (Protobuf3Parser.PROTO3_LIT_DOBULE - 34)) | (1 << (Protobuf3Parser.PROTO2_LIT_SINGLE - 34)) | (1 << (Protobuf3Parser.PROTO2_LIT_DOBULE - 34)) | (1 << (Protobuf3Parser.STR_LIT - 34)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
