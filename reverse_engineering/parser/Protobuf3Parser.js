...
Protobuf3Parser.LINE_COMMENT = 61;
...
Protobuf3Parser.prototype.proto = function() {
    ...
    try {
        ...
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << Protobuf3Parser.IMPORT) | (1 << Protobuf3Parser.PACKAGE) | (1 << Protobuf3Parser.OPTION) | (1 << Protobuf3Parser.ENUM) | (1 << Protobuf3Parser.MESSAGE))) !== 0) || _la===Protobuf3Parser.SERVICE || _la===Protobuf3Parser.SEMI) {
            this.state = 108;
            this._errHandler.sync(this);
